...
'''
My function designed like this, that the output will be in ascending order, from smallest to largest.
This meets the requirements of section A and section B in the assignment together.
'''
